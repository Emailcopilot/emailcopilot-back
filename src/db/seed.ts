...
{{senderName}}`,
  ...
  const [sub] = await db
    ...
    .values({
      ...
      planId: "pro",
      status: "active",
      mollieSubscriptionId: "sub_example123",
      mollieCustomerId: "cus_example123",
  ...
  await db.insert(schema.invoices).values([
    {
      ...
      molliePaymentId: "in_example_apr",
      amount: 7900,
      currency: "eur",
      status: "paid",
      downloadUrl: "https://mollie.com/invoice/example_apr",
      paidAt: new Date("2025-04-01"),
    },
    {
      userId: user.id,
      subscriptionId: sub.id,
      molliePaymentId: "in_example_mar",
      amount: 7900,
      currency: "eur",
      status: "paid",
      downloadUrl: "https://mollie.com/invoice/example_mar",
      paidAt: new Date("2025-03-01"),
    },
    {
      userId: user.id,
      subscriptionId: sub.id,
      molliePaymentId: "in_example_feb",
      amount: 2900,
      currency: "eur",
      status: "paid",
      downloadUrl: "https://mollie.com/invoice/example_feb",
